...
<p>By accessing or using {process.env.NEXT_PUBLIC_APPNAME} (&quot;we,&quot; &quot;us,&quot; &quot;our&quot;), you agree to comply with and be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, you may not access or use our services.</p>

<h2>2. Description of Services</h2>
<p>{process.env.NEXT_PUBLIC_APPNAME} provides a platform that allows users to summarize Youtube videos using artificial intelligence (&quot;Services&quot;). We reserve the right to modify or discontinue any aspect of our Services at any time without prior notice.</p>
...
<p>All intellectual property rights in the platform, including but not limited to software, design, and text, are owned by {process.env.NEXT_PUBLIC_APPNAME} or our licensors. You may not reproduce, modify, distribute, or otherwise exploit any content on our platform without our prior written consent.</p>

<h2>7. Third-Party Integrations</h2>
<p>Our platform may integrate with third-party services, such as Stripe, to enhance your experience. By using these integrations, you agree to comply with all third-party terms and grant us access to necessary information (e.g., access tokens) to facilitate the integration.</p>
...
<p>To the fullest extent permitted by law, {process.env.NEXT_PUBLIC_APPNAME} shall not be liable for any indirect, incidental, special, or consequential damages arising from or in connection with your use of our Services. Our total liability to you for any claim related to the Services shall not exceed the amount paid by you in the preceding twelve (12) months.</p>
